...
class PathPlanner():
    ...
    def plan_paths(self, move:chess.Move) -> list[Waypoint]:
        '''
    ...
    def path(self, piece_type:chess.PieceType, start:chess.Square, target:chess.Square) -> list[tuple]:
        '''
        Given starting/target locations and a piece type, generate list of points
        piece needs to travel to
